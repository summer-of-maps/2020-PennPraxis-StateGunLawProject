...
The plots below show the Moran's I (extent of spatial clustering), count of gun crimes, and Siegel Score for every city by year. The x-axis is aligned on each, so you can read straight down, but some of the cities with fewer years of data will look compressed horizontally.
...
* **St. Louis County:** Decrease in Siegel Score and icnrease in crimes. 
...
These maps show high- and low-crime clusters, as well as areas with high- or low-crime compared to their neighbors.
